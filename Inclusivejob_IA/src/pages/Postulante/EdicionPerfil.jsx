      ...
      <div style={{ maxWidth:"1000px", margin:"0 auto" }}>
        ...
        <div style={{ background:t.bgSurface, border:`1px solid ${t.border}`, borderRadius:"16px", overflow:"hidden", boxShadow:"0 4px 16px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ borderBottom:`1px solid ${t.border}`, padding:"12px 28px", display:"flex", flexWrap:"wrap", gap:"16px 24px" }}>
            {[["📧","Correo",perfil.email],["📱","Teléfono",displayPhone()],["🔗","Portafolio",perfil.portafolio]].map(([ic,label,val]) => (
              ...
              {tab === "info" && (
                <div style={{ display:"flex", flexDirection:"column", gap:"12px" }}>
                    ...
                    <div style={{ width:"64px", height:"64px", borderRadius:"10px", overflow:"hidden", border:`2px solid ${t.border}`, flexShrink:0, background:t.accentSoft, display:"flex", alignItems:"center", justifyContent:"center", fontSize:"20px", fontWeight:700, color:t.accent }}>
                      {fotoPreview
                        ...
                        : perfil.foto_perfil
                          ...
                          : getInitials(`${draft.nombres} ${draft.apellidos}`)
                      }
                    </div>
                    <div>
                  ...
                  <div style={{ display:"flex", gap:"8px" }}>
                    <div style={{ flex:1 }}>
                      <label htmlFor="f-nombres" style={{ fontSize:"12px", fontWeight:500, color:t.textSecondary, display:"block", marginBottom:"4px" }}>Nombre(s)</label>
                      <input id="f-nombres" type="text"
                        ...
                        value={draft.nombres} onChange={e => setDraft(d => ({ ...d, nombres:e.target.value }))} />
                    </div>
                    <div style={{ flex:1 }}>
                      <label htmlFor="f-apellidos" style={{ fontSize:"12px", fontWeight:500, color:t.textSecondary, display:"block", marginBottom:"4px" }}>Apellido(s)</label>
                      <input id="f-apellidos" type="text"
                        style={{ width:"100%", border:`1px solid ${t.border}`, borderRadius:"10px", padding:"8px 12px", fontSize:"13px", background:t.bgElevated, color:t.textPrimary, outline:"none", boxSizing:"border-box" }}
                        value={draft.apellidos} onChange={e => setDraft(d => ({ ...d, apellidos:e.target.value }))} />
                    </div>
                  </div>
                  ...
                  {/* Portafolio */}
                  <div>
                    <label htmlFor="f-portafolio" style={{ fontSize:"12px", fontWeight:500, color:t.textSecondary, display:"block", marginBottom:"4px" }}>URL Portafolio</label>
                    <input id="f-portafolio" type="url"
                      style={{ width:"100%", border:`1px solid ${t.border}`, borderRadius:"10px", padding:"8px 12px", fontSize:"13px", background:t.bgElevated, color:t.textPrimary, outline:"none", boxSizing:"border-box" }}
                      value={draft.portafolio} onChange={e => setDraft(d => ({ ...d, portafolio:e.target.value }))} />
                  </div>
